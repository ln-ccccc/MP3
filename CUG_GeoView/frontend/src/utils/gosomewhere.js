...
function goIndexCalc(){
    this.isNavigator = false;
    if (this.$route.path === "/indexcalc") {
        this.$message.success('您已经在该界面了哦')
    } else this.$router.push("indexcalc");
}
...
export { goDetectChanges, goDetectObjects, goSegmentation,goClassification,goRestoreImgs,goOnlineMap,goHistory, goIndexCalc }
